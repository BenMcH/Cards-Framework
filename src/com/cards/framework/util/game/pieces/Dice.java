...
/**
 * Adds the dice game piece for games like Yahtzee or Monopoly.
 * TODO: Allow custom dice.
 * 
 * @author William
 *
 */
...
public class Dice extends GamePiece implements Rollable{
	...
	public static final int[] availableSizes = {
		6
	};
	
	/**
	 * If object is given no attributes, if creates a 
	 * default white, 6-sided die.
	 */
	...
	/**
	 * Documentation for these are in the implemented class "Rollable"
	 */
